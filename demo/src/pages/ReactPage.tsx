  ...
  return (
    <div className="demo">
      <header className="demo__header">
        <div>
          <span className="demo__tag">{t('react.tag')}</span>
          <h1 className="demo__title">{t('react.title')}</h1>
          <p className="demo__subtitle">{renderCode(t('react.subtitle'))}</p>
        </div>
      ...
      <div className="demo__metrics">
        <div className="demo__metric">
          <span className="demo__metric-label">{t('react.stateLabel')}</span>
          <span className="demo__metric-value">{c.state}</span>
        </div>
        <div className="demo__metric">
          <span className="demo__metric-label">{t('react.bypassLabel')}</span>
          <span className="demo__metric-value">{String(c.bypass)}</span>
        </div>
        <div className="demo__metric">
          <span className="demo__metric-label">{t('react.outputStreamLabel')}</span>
          <span className="demo__metric-value">{c.outputStream ? t('react.mediaStream') : t('react.null')}</span>
        </div>
      </div>
