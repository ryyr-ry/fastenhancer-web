/*
 * base_48k.h — 48kHz Base モデル設定
 *
 * FastEnhancer ICASSP 2026 論文のBaseモデル(48kHz版)の全定数。
...
/* アーキテクチャ定数 */
#define FE_C1               48      /* Encoder/Decoderチャネル数 */
#define FE_C2               36      /* RNNFormerチャネル数 */
#define FE_F1               128     /* ストライド後周波数 (FREQ_BINS / STRIDE) */
#define FE_F2               36      /* RNNFormer周波数次元 */
