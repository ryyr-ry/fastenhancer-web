/*
 * tiny_48k.h — 48kHz Tiny model configuration
 *
 * All constants for the FastEnhancer ICASSP 2026 paper Tiny model (48kHz version).
...
#define FE_F2               24      /* RNNFormer frequency dimension */
#define FE_ENC_BLOCKS       2       /* Number of Encoder blocks */
#define FE_RF_BLOCKS        2       /* Number of RNNFormer blocks */
#define FE_STRIDE           4
